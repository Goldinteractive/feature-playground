...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    ...
    factory(exports, require('gi-js-base'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.giJsBase);
    global.index = mod.exports;
  }
})(this, function (exports, _giJsBase) {
  'use strict';
  ...
  var _giJsBase2 = _interopRequireDefault(_giJsBase);
  ...
  var Playground = function (_gi$features$Feature) {
    _inherits(Playground, _gi$features$Feature);
    ...
    return Playground;
  }(_giJsBase2.default.features.Feature);
